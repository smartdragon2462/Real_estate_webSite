...
if ( ! function_exists( 'inspiry_add_membership_module' ) ) {
	...
	function inspiry_add_membership_module( $current_user ) {
		...
		<div class="row-fluid">
			...
			<div class="span4">
				<h3><?php esc_html_e( 'Available Memberships', 'framework' ); ?></h3>
				<?php inspiry_show_all_memberships(); ?>
			</div>
			<!-- /.span4 available-memberships -->

			<div class="span4">
				<h3><?php esc_html_e( 'Your Current Membership', 'framework' ); ?></h3>
				<?php inspiry_current_membership(); ?>
			</div>
			<!-- /.span4 current-membership -->

			<div class="span4">
				<h3><?php esc_html_e( 'Update Membership', 'framework' ); ?></h3>
...
if ( ! function_exists( 'inspiry_current_membership' ) ) {
	...
	function inspiry_current_membership() {
		...
		if ( is_array( $current_membership ) && ! empty( $current_membership ) ) : ?>
			...
			<div class="rh_memberships__wrap">
				...
				<ul class="details">
					...
					<?php if ( isset( $current_membership[ 'format_price' ] ) && ! empty( $current_membership[ 'format_price' ] ) ) : ?>
						<li><?php echo esc_html( sprintf( esc_html__( "Price: %s", 'framework' ), $current_membership[ 'format_price' ] ) ); ?></li><!-- Price -->
					<?php endif; ?>

					<?php if ( isset( $current_membership[ 'properties' ] ) ) : ?>
						<li><?php echo esc_html( sprintf( esc_html__( "Properties Allowed: %s", 'framework' ), $current_membership[ 'properties' ] ) ); ?></li><!-- Properties Allowed -->
					<?php endif; ?>

					<?php if ( isset( $current_membership[ 'current_props' ] ) ) : ?>
						<li><?php echo esc_html( sprintf( esc_html__( "Properties Left: %s", 'framework' ), $current_membership[ 'current_props' ] ) ); ?></li><!-- Properties Left -->
					<?php endif; ?>

					<?php if ( isset( $current_membership[ 'featured_prop' ] ) ) : ?>
						<li><?php echo esc_html( sprintf( esc_html__( "Featured Properties: %s", 'framework' ), $current_membership[ 'featured_prop' ] ) ); ?></li><!-- Featured Properties -->
					<?php endif; ?>

					<?php if ( isset( $current_membership[ 'current_featured' ] ) ) : ?>
						<li><?php echo esc_html( sprintf( esc_html__( "Featured Properties Left: %s", 'framework' ), $current_membership[ 'current_featured' ] ) ); ?></li><!-- Featured Properties Left -->
					<?php endif; ?>
					...
					<?php if ( isset( $current_membership[ 'duration' ] ) && ! empty( $current_membership[ 'duration' ] ) ) : ?>
						<li><?php
							if ( $current_membership[ 'duration' ] > 1 ) {
								...
								$readable_duration_unit = $ims_functions::get_readable_duration_unit( $duration_unit );
								echo esc_html( sprintf( esc_html__( "Time Duration: %s %s", 'framework' ), $current_membership[ 'duration' ], $readable_duration_unit ) );
							} else {
					...
					<?php if ( isset( $current_membership[ 'due_date' ] ) && ! empty( $current_membership[ 'due_date' ] ) ) : ?>
						<li><?php
							...
							echo esc_html( sprintf( esc_html__( "Due Date: %s", 'framework' ), $date ) );
							?></li><!-- Due Date -->
					<?php endif; ?>
			...
			echo '<h4>' . esc_html__( 'You have no current membership.', 'framework' ) . '</h4>';
