...
if ( ! function_exists( 'inspiry_payments_customizer' ) ) :
	function inspiry_payments_customizer( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section( 'inspiry_members_payments', array(
			'title' => esc_html__( 'Payments', 'framework' ),
		...
		$wp_customize->add_control( 'theme_enable_paypal', array(
			'label' => esc_html__( 'Enable PayPal Payments for Submitted Property', 'framework' ),
			'type' => 'radio',
		...
		$wp_customize->add_control( 'theme_paypal_ipn_url', array(
			'label' => esc_html__( 'PayPal IPN URL', 'framework' ),
		...
		$wp_customize->add_control( 'theme_paypal_merchant_id', array(
			'label' => esc_html__( 'PayPal merchant account ID or Email', 'framework' ),
			'type' => 'text',
			'section' => 'inspiry_members_payments',
		) );
		...
		$wp_customize->add_control( 'theme_enable_sandbox', array(
			'label' => esc_html__( 'Enable PayPal Sandbox for Testing', 'framework' ),
			'type' => 'radio',
			'section' => 'inspiry_members_payments',
			'choices' => array(
				'true' => esc_html__( 'Yes', 'framework' ),
		...
		$wp_customize->add_control( 'theme_payment_amount', array(
			'label' => esc_html__( 'Payment Amount Per Property', 'framework' ),
			'description' => esc_html__( 'Provide the amount that you want to charge for one property. Example: 20.00', 'framework' ),
			'type' => 'text',
			'section' => 'inspiry_members_payments',
		) );
		...
		$wp_customize->add_control( 'theme_currency_code', array(
			'label' => esc_html__( 'Currency Code', 'framework' ),
			'description' => esc_html__( 'Provide currency code that you want to use. Example: USD', 'framework' ),
			'type' => 'text',
			'section' => 'inspiry_members_payments',
		) );
		...
		$wp_customize->add_control( 'theme_publish_on_payment', array(
			'label' => esc_html__( 'Automatically Publish Submitted Property after Payment', 'framework' ),
			'type' => 'radio',
			'section' => 'inspiry_members_payments',
			'choices' => array(
				'true' => esc_html__( 'Yes', 'framework' ),
