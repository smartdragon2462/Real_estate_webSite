...
if ( ! function_exists( 'inspiry_search_form_customizer' ) ) :
	...
	function inspiry_search_form_customizer( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control( 'theme_show_home_search', array(
			'label' 			=> esc_html__( 'Properties Search Form on Homepage', 'framework' ),
			'description' 		=> esc_html__( 'You can configure properties search form using related section.', 'framework' ),
			'type' 				=> 'radio',
		...
		if ( 'modern' === INSPIRY_DESIGN_VARIATION ) {
			...
			$wp_customize->add_control( 'inspiry_search_label_text', array(
				'label'       => esc_html__( 'Advance Search Label Text', 'framework' ),
				'description' => esc_html__( 'This text will be replaced with Advance Search Label Image', 'framework' ),
				'type'     => 'text',
				'section'  => 'inspiry_home_search',
