...
$knowledge_base_postbox = array(
	...
	'posts' => array(
        array(
			'title' => 'How to Update Real Homes Theme Safely',
...
$extend_support = array(
	...
	'posts' => array(
		array(
			'description' => sprintf( 'Real Homes comes with 6 months of free support with your purchase. Support can be <a href="%s" target="_blank">extended or renewed</a> via themeforest.', esc_url( 'https://support.inspirythemes.com/knowledgebase/extend-renew-support/' ) )
		),
	)
);
?>
