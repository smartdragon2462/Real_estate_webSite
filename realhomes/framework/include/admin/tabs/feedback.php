...
<!--    <h2 class="inspiry-title">--><?php //esc_html_e( 'Feedback', 'framework' ); ?><!--</h2>-->
    <div class="description">
        <p><?php esc_html_e( 'We value your feedback as it helps us improve our products and in result you get a better product after every update.', 'framework' ); ?></p>
        <p><?php esc_html_e( 'So, Participate in our improvement efforts by providing us your valuable feedback.', 'framework' ); ?></p>
    </div>
    <div class="row">
        <div class="col-3">
