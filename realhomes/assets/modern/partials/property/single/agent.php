				...
				if ( isset( $args['agent_title_text'] ) && ! empty( $args['agent_title_text'] ) ) {
					...
					<p>
						...
						if( 'true' === $theme_display_agent_detail_page_link ) {
							...
							if ( isset( $args['display_author'] ) && ( $args['display_author'] ) ) { ?>
                                <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php echo esc_html( $theme_agent_detail_page_link_text ); ?></a><?php
							} else { ?>
                                <a href="<?php echo esc_url( get_permalink( $args['agent_id'] ) ); ?>"><?php echo esc_html( $theme_agent_detail_page_link_text ); ?></a><?php
							}
						}
						?>
					</p>
                ...
                <div class="rh_property__agent_contact rh_agent_form">
                    <form id="<?php echo esc_attr( $agent_form_id ); ?>" class="agent-form contact-form-small" method="post"
                        ...
                        <div class="rh_agent_form__field rh_agent_form__textarea">
                            ...
                            <textarea rows="6" name="message" id="comment-<?php echo esc_attr( $agent_form_id ); ?>"
                                      class="required" placeholder="<?php esc_attr_e( 'Your Message', 'framework' ); ?>"
                                      title="<?php esc_attr_e( '* Please provide your message', 'framework' ); ?>"></textarea>
                        </div>
                        ...
                        if ( $is_gdpr_enabled ) {
                            ...
                            if ( ! empty( $gdpr_agreement_text ) ) {
                                ?>
                                <div id="rh_inspiry_gdpr-<?php echo esc_html( $agent_form_id ); ?>" class="rh_inspiry_gdpr clearfix">
                                    <?php
                        ...
                        <div class="rh_agent_form__row">
                            ...
                            <input type="hidden" name="target"
                                   value="<?php echo esc_attr( antispambot( $args['agent_email'] ) ); ?>">
                            ...
                            <input type="submit" value="<?php esc_attr_e( 'Send Message', 'framework' ); ?>" name="submit"
                                   class="submit-button rh_btn rh_btn--primary">
                        ...
                        <div class="rh_agent_form__row">
                            <div id="error-container-<?php echo esc_attr( $agent_form_id ); ?>"
                                 class="error-container"></div>
                            <div id="message-container-<?php echo esc_attr( $agent_form_id ); ?>"
