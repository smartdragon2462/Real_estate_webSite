...
<div class="rh_my-property clearfix">
	...
	<div class="rh_my-property__controls">
		...
		if ( current_user_can( 'delete_posts' ) ) {
			?>
			<a class="delete" href="#">
				<i class="fa fa-trash"></i> <?php esc_html_e( 'Delete', 'framework' ); ?>
			</a>
			<span class="confirmation hide">
				<a class="confirm remove-my-property"
				   ...
				   title="<?php esc_attr_e( 'Remove This Property', 'framework' ); ?>">
					...
					<i class="fa fa-spinner fa-spin loader"></i> <?php esc_html_e( 'Confirm', 'framework' ); ?>
				</a>
				<a href="#" class="cancel">
					<i class="fa fa-close"></i> <?php esc_html_e( 'Cancel', 'framework' ); ?>
				</a>
			</span>
			<?php
		}
