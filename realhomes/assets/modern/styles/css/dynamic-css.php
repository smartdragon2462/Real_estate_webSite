...
if ( ! function_exists( 'inspiry_generate_dynamic_css' ) ) {
	...
	function inspiry_generate_dynamic_css() {
		...
		if ( $prop_count_cta > 0 ) {
			echo "<style type='text/css' id='dynamic-css-cta'>\n\n";
		...
		if ( $prop_count_label > 0 ) {
			echo "<style type='text/css' id='dynamic-css-label-mod'>\n\n";
			foreach ( $dynamic_css_label as $label_unit ) {
				if ( ! empty( $label_unit['value'] ) ) {
					echo strip_tags( $label_unit['elements'] . " { " . $label_unit['property'] . " : " . $label_unit['value'] . ";" . " }\n" );
				}
			}
			echo '</style>';
		}
		...
		$dynamic_css = array(
			...
			array(
				'elements' => '	.inspiry_mod_search_form_smart .select2-container--default .select2-results>.select2-results__options::-webkit-scrollbar,
			...
			array(
				'elements' => '.inspiry_mod_search_form_smart .select2-container--default .select2-results__option--highlighted[aria-selected], 
			...
			array(
				'elements' => '.inspiry_mod_search_form_smart .select2-container--default .select2-results>.select2-results__options::-webkit-scrollbar-thumb',
				'property' => 'background',
				'value'    => inspiry_hex_darken( $core_orange_color, 8 ),
			),
			...
			array(
				'elements' => '.rh_my-property .rh_my-property__publish .publish h5',
				'property' => 'color',
				'value'    => inspiry_hex_to_rgba( $core_green_color, 4 ),
			),
			array(
				'elements' => '.rh_overlay',
				'property' => 'background',
...
//								.rh_var_header .rh_menu__user_submit a',
//				'property' => 'color',
//				'value'    => $theme_header_submit_text,
//			),
//
//			array(
//				'elements' => '.rh_menu__user .rh_menu__user_submit a:hover,
//								.rh_var_header .rh_menu__user_submit a',
//				'property' => 'background',
//				'value'    => $theme_header_submit_bg_hover,
//			),
//
//			array(
//				'elements' => '.rh_menu__user .rh_menu__user_submit a:hover,
//								.rh_var_header .rh_menu__user_submit a',
//				'property' => 'color',
//				'value'    => $theme_header_submit_text_hover,
//			),
//
		);
