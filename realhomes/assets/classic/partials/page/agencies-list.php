														...
														<ul class="contacts-list">
															<?php
																if ( ! empty( $agent_office_phone ) ) {
																	?><li class="office"><?php include( INSPIRY_THEME_DIR . '/images/icon-phone.svg' ); esc_html_e( 'Office', 'framework' ); ?> : <?php echo esc_html( $agent_office_phone ); ?></li><?php
																}
																if ( ! empty( $agent_mobile ) ) {
																	?><li class="mobile"><?php include( INSPIRY_THEME_DIR . '/images/icon-mobile.svg' ); esc_html_e( 'Mobile', 'framework' ); ?> : <?php echo esc_html( $agent_mobile ); ?></li><?php
																}
																if ( ! empty( $agent_office_fax ) ) {
																	?><li class="fax"><?php include( INSPIRY_THEME_DIR . '/images/icon-printer.svg' ); esc_html_e( 'Fax', 'framework' ); ?>  : <?php echo esc_html( $agent_office_fax ); ?></li><?php
																}
																if ( ! empty( $agent_whatsapp ) ) {
																	?><li class="fax"><?php include( INSPIRY_THEME_DIR . '/images/icon-whatsapp.svg' ); esc_html_e( 'WhatsApp', 'framework' ); ?>  : <?php echo esc_html( $agent_whatsapp ); ?></li><?php
																}
															?>
														</ul>
														<?php
