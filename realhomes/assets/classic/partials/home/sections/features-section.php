								...
								<div class="span3 features-single">
										...
										<div class="feature-img">
											<?php if ( ! empty( $feature_url_first ) ) : ?>
												<a href="<?php echo esc_url( $feature_url_first ); ?>">
													<img src="<?php echo esc_url( $feature_image_first ); ?>" alt="<?php echo esc_html( $feature_title_first ); ?>"/>
												</a>
											<?php else : ?>
												<img src="<?php echo esc_url( $feature_image_first ); ?>" alt="<?php echo esc_html( $feature_title_first ); ?>"/>
											<?php endif; ?>
									...
									<div class="feature-content">
										...
										if ( ! empty( $feature_desc_first ) ) {
											echo '<p>' . wp_kses( $feature_desc_first, inspiry_allowed_html() ) . '</p>';
										}
										?>
									</div>
									<!-- /.feature-content -->
								...
								<div class="span3 features-single">
										...
										<div class="feature-img">
											<?php if ( ! empty( $feature_url_second ) ) : ?>
												<a href="<?php echo esc_url( $feature_url_second ); ?>">
													<img src="<?php echo esc_url( $feature_image_second ); ?>" alt="<?php echo esc_html( $feature_title_second ); ?>"/>
												</a>
											<?php else : ?>
												<img src="<?php echo esc_url( $feature_image_second ); ?>" alt="<?php echo esc_html( $feature_title_second ); ?>"/>
											<?php endif; ?>
									...
									<div class="feature-content">
										...
										if ( ! empty( $feature_desc_second ) ) {
											echo '<p>' . wp_kses( $feature_desc_second, inspiry_allowed_html() ) . '</p>';
										}
										?>
									</div>
									<!-- /.feature-content -->
								...
								<div class="span3 features-single">
										...
										<div class="feature-img">
											<?php if ( ! empty( $feature_url_third ) ) : ?>
												<a href="<?php echo esc_url( $feature_url_third ); ?>">
													<img src="<?php echo esc_url( $feature_image_third ); ?>" alt="<?php echo esc_html( $feature_title_third ); ?>"/>
												</a>
											<?php else : ?>
												<img src="<?php echo esc_url( $feature_image_third ); ?>" alt="<?php echo esc_html( $feature_title_third ); ?>"/>
											<?php endif; ?>
									...
									<div class="feature-content">
										...
										if ( ! empty( $feature_desc_third ) ) {
											echo '<p>' . wp_kses( $feature_desc_third, inspiry_allowed_html() ) . '</p>';
										}
										?>
									</div>
									<!-- /.feature-content -->
