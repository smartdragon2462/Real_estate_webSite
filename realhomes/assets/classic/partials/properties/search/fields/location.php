...
for ($i=0; $i < $location_select_count; $i++) {
    ?>
	<div class="option-bar rh-search-field small rh_classic_search__select rh_location_prop_search_<?php echo esc_attr( $i ) ?>" data-get-location-placeholder="<?php echo esc_attr( $location_placeholder[$i] ); ?>">
