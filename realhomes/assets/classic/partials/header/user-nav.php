    ...
    <div class="user-nav clearfix">
		...
		if ( ! empty( $favorites_url ) ) {
			...
			if ( ( is_user_logged_in() && 'yes' == $require_login ) || ( 'yes' != $require_login ) ) {
				?>
                <a href="<?php echo esc_url( $favorites_url ); ?>"><i class="fa fa-star"></i><?php esc_html_e( 'Favorites', 'framework' ); ?>
                </a>
				<?php
			} else {
				?>
                <a href="#login-modal" data-toggle="modal">
                    <i class="fa fa-star"></i><?php esc_html_e( 'Favorites', 'framework' ); ?>
                </a>
				<?php
			}
		...
		if ( !empty( $submit_url ) ) {
			$inspiry_show_submit_on_login = get_option( 'inspiry_show_submit_on_login', 'true' );
			...
			if ( 'true' == $inspiry_show_submit_on_login ) {
				if ( is_user_logged_in() ) { ?>
                    <a href="<?php echo esc_url( $submit_url ); ?>">
                        <i class="fa fa-plus-circle"></i><?php echo esc_html( $theme_submit_button_text ); ?>
                    </a>
					<?php
				}
			} else { ?>
		...
		if ( is_user_logged_in() ) {
			...
			if ( ! empty( $my_properties_url ) ) {
                ...
                <i class="fa fa-th-list"></i><?php esc_html_e( 'My Properties', 'framework' ); ?></a><?php
			...
			if ( ! empty( $profile_url ) ) {
                ...
                <i class="fa fa-user"></i><?php esc_html_e( 'Profile', 'framework' ); ?></a><?php
            ...
            <i class="fa fa-sign-out"></i><?php esc_html_e( 'Logout', 'framework' ); ?></a><?php
			...
			if ( ! empty( $theme_login_url ) ) {
                ...
                <i class="fa fa-sign-in"></i><?php esc_html_e( 'Login / Register', 'framework' ); ?></a><?php
